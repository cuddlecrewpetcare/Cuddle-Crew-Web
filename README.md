...
For coordinated Codex tasks, start with [the operating guide](docs/codex/ORCHESTRATION.md) and [current operational status](docs/codex/PROJECT_STATUS.md). They reference the existing project contracts and preserve separate implementation, review, merge, and deployment authority.
