...
export default function SiteFooter(){
 return <footer className="site-footer"><div className="shell footer-grid">
  ...
  <nav aria-label="Trust and policies"><h2>Trust & policies</h2><div className="footer-link-list"><Link href="/safety">Safety</Link><Link href="/choosing-care">Choosing care</Link><Link href="/credentials">Credentials</Link><Link href="/faq">FAQ</Link><Link href="/holidays">Holidays</Link><Link href="/accessibility">Accessibility</Link><Link href="/privacy">Privacy</Link><Link href="/terms">Terms</Link></div></nav>
