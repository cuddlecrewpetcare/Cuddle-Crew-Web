export default function SiteHeader(){
 return <nav className="nav shell" aria-label="Primary navigation">
  ...
  <div className="nav-links"><a href="/#services">Services</a><a href="/#care-guide">Pet care guide</a><a href="/#area">Service area</a><a href="/#photos">Photos</a><a href="/credentials">Peace of mind</a><a href="/faq">FAQ</a></div>
