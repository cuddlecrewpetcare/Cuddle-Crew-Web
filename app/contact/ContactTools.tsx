...
export default function ContactTools(){
  ...
  const submit=async(event:FormEvent<HTMLFormElement>)=>{
    ...
    try{
      const response=await fetch('/api/contact',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({name,replyTo,phone,zip,topic,message,website:data.get('website'),startedAt:startedAt.current})});
