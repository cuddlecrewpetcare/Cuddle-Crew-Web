...
['Pricing','What if I need care at short notice?',`Daytime requests under 48 hours before the selected window include $${business.pricing.shortNoticeVisit} per visit. Same-day daytime requests include $${business.pricing.sameDayVisit} per visit instead, not both fees. Overnight requests under 48 hours may include $${business.pricing.shortNoticeOvernight} per overnight day. All depend on availability and are evaluated in Pacific Time.`],
...
['Pricing','Which dates have holiday charges?',`New Year’s Day, Easter, Mother’s Day, Independence Day, Thanksgiving, Christmas Eve, Christmas Day, and New Year’s Eve. Daytime visits add $${business.pricing.holidayVisit} per visit; overnight care adds $${business.pricing.holidayOvernight} per day.`],
['Services','What does an overnight include?',`Overnight care is ${business.overnight.label} and excludes daytime care. One 30-minute midday visit may be added for $${business.pricing.overnightMidday} per overnight day, plus applicable pet, travel, holiday, and short-notice charges.`],
...
['Services','Which services are not offered?','Boarding, continuous 24-hour care, grooming, training, veterinary procedures, injections, off-leash walks, and dog-park visits are not offered.'],
