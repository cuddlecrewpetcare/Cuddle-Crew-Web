...
export function parsePlannerPrefill(search:string):PlannerPrefill|null{
 ...
 const count=Math.max(1,Math.min(8,Number(params.get('pets'))||1)),household=params.get('household')||'',duration=params.get('duration')==='60'?60:30;
