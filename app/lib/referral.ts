...
export const parseReferralSource=(value:unknown):ReferralSource|undefined=>typeof value==='string'&&value.length<=24&&/^[a-z-]+$/.test(value)&&referralSources.includes(value as ReferralSource)?value as ReferralSource:undefined;
