...
>
> Website use: Overall service scope, booking framework, safety limitations, client obligations, scheduling expectations, payment framework, and incorporated policies.

## Purpose

This document contains the current approved Master Service Agreement used by Cuddle Crew Pet Care LLC through Precise Petcare.

This document is the authoritative client-facing source for the contractual subjects it covers. Website copy, functionality, booking logic, and client-facing explanations must remain consistent with this Agreement.
...
Routine booking communications, care instructions, confirmations, and operational updates may be provided through Precise Petcare, email, or another communication method designated by the Contractor. Formal notice under this Agreement will be deemed to be properly delivered:
   ...
   b. immediately upon being served personally;

   c. upon documented delivery through an approved electronic communication method;

   d. two days after being deposited with the postal service if served by registered or certified mail; or

   e. the following business day after being deposited with a nationally recognized overnight courier.
...
The website must remain consistent with this Agreement.

In particular:

- Services are defined by the confirmed booking and the Client’s current approved Precise Petcare records.
- Website descriptions may explain available services but must not imply that every requested service or task will automatically be accepted.
- Services outside Cuddle Crew’s training, insurance coverage, safety limits, legal scope, or agreed service scope may be modified, declined, or referred out.
- Routine daytime services use agreed service windows and must not be represented as guaranteed exact-minute arrival times unless an exact-time requirement has specifically been accepted.
- Website pricing and payment information must remain consistent with the current Pricing, Fees & Surcharge Policy.
...
- Medication-related website claims must remain consistent with the applicable medication consent and scope-review documents.
- Shared-care or third-party-care website information must remain consistent with the applicable shared-care agreement and internal coordination rules.
- Website descriptions of access, keys, security systems, cameras, and home-entry requirements must remain consistent with the applicable Access, Key & Home Security Agreement.
- Client-specific pet information, care instructions, access details, schedules, and approved service plans belong in Precise Petcare and must not be replaced by generic website data.
- Public website functionality must not expose client Confidential Information, access credentials, travel plans, veterinary information, medication details, or other sensitive records described by this Agreement.
- Public use of pet photographs, videos, testimonials, client names, or other identifying information must remain consistent with the Client’s Media, Photo & Testimonial Consent.
- If existing website behavior conflicts with this Agreement, the conflict must be flagged and corrected rather than silently changing or weakening the Agreement.

## Codex Guardrails

- Do not infer missing policies.
- Do not treat TODOs, examples, or older website behavior as business rules.
- Treat the Authoritative Content section of this CURRENT / APPROVED document as the source of truth for the contractual subjects it covers.
- Do not alter, weaken, broaden, narrow, reinterpret, or replace an authoritative contractual rule merely to make implementation easier.
- Do not convert internal operational rules into public contractual promises without explicit instruction.
- Do not expose private operational details merely because they appear in a business-reference document.
- Do not expose internal thresholds, risk logic, capacity calculations, route assumptions, or decline criteria publicly unless explicitly approved.
- Do not make existing website code authoritative over this document.
- If website behavior or another CURRENT / APPROVED reference materially conflicts with this document, flag the conflict for human review rather than silently reconciling it.
- Do not invent a missing rate, deadline, threshold, service requirement, eligibility rule, or exception.
