...
>
> Authority: AUTHORITATIVE FOR THE SUBJECTS COVERED BY THIS DOCUMENT
>
> Website use: Public rates, estimate-builder logic, additional-pet pricing, holiday fees, short-notice fees, travel fees, payment timing, reservation payments, quotes, and pricing disclosures.

## Purpose

This document contains the current approved Pricing, Fees & Surcharge Policy used by Cuddle Crew Pet Care LLC through Precise Petcare.

This document is the authoritative client-facing source for standard rates, additional-pet pricing, holiday and peak-date surcharges, short-notice and same-day fees, travel and service-area fees, payment timing, reservation payments, quotes, confirmed pricing, access-related charges, direct costs, discounts, rate changes, custom pricing, and related financial rules.

Website pricing displays, estimate-builder behavior, service descriptions, FAQs, booking flows, and client-facing payment information must remain consistent with this Policy.
...
2. All notices, requests, demands or other communications required or permitted by the terms of this Policy will be given in writing and delivered using the contact information maintained by the Parties. Notices to the Client may be delivered using the Client’s then-current mailing address, email address, telephone number, or other contact information maintained in the Client’s Precise Petcare account. Notices to the Contractor may be delivered to:
   ...
   a. Cuddle Crew Pet Care LLC  
   2108 N St Ste N  
   Sacramento, CA 95811  
   lauren@cuddlecrewpetcare.com

Routine booking communications, cancellation requests, booking-change requests, care instructions, confirmations, quotes, invoices, and operational updates may be provided through Precise Petcare, email, telephone, or another communication method designated by the Contractor.
...
A travel or extended-service-area fee does not guarantee acceptance of a booking. All Services remain subject to availability and route feasibility, and the Contractor may decline a Service where the location, route, travel burden, schedule, or other operational considerations make the booking impractical.

The Contractor may reduce or waive an otherwise applicable travel fee in an individual circumstance where the additional travel burden is minimal, provided that such accommodation does not modify the service-area classification or pricing applicable to future bookings.
...
The website must remain consistent with this Policy.

### Standard Service Pricing

The website may display the following current standard rates:
...
- Additional dog: +$10 per applicable visit, walk, or Overnight.
- Additional cat: +$5 per applicable visit or Overnight.
- Additional small animal: +$5 per applicable visit or Overnight where appropriate.
- Additional-pet pricing applies only where the complete routine safely and reasonably fits within the booked duration.
...
- Cancellation treatment must defer to the Cancellation, Booking Change & Refund Policy.

### Short-Notice and Same-Day Requests

- Less than 24 hours before a daytime Service, but not same calendar day: may add $10 per visit.
- Same-calendar-day daytime request: may add $20 per visit.
- The $20 same-day fee replaces the $10 short-notice fee.
- Do not stack the $10 and $20 fees.
- Overnight requested less than 48 hours before the requested Overnight: may add $25 per night.
- Short-notice fees do not guarantee availability.
- Short-notice requests may still require review or be declined.
- Discretionary fee waivers must not be represented as guaranteed.

### Travel and Service Area

The website and estimate builder must preserve these travel tiers:

- Core: approximately 0–10 minutes one way — included.
- Standard: more than 10–20 minutes one way — included.
- Extended: more than 20–30 minutes one way — +$10 per daytime visit.
- Far Extended: more than 30–45 minutes one way — +$20 per daytime visit.
- Beyond 45 minutes — personalized review / generally unavailable unless approved.

Additional rules:

- Service-area classification is based on typical or ordinary one-way travel time under normal driving conditions.
- Temporary traffic, collisions, construction, closures, or abnormal congestion should not dynamically change an established travel zone merely because current traffic is worse than normal.
- Overnight Services outside the Standard Zone require individualized review.
- The estimator must not automatically apply daytime travel surcharges to Overnights outside the Standard Zone.
- A travel surcharge does not guarantee booking acceptance.
- Route feasibility and capacity remain separate considerations.
- A private service-area reference point must not be exposed to the browser or client.
- If a routing API is used in the future, any private origin/reference data and API secrets must remain server-side.

### Payment Timing

- Ordinary payment deadline: seventy-two (72) hours before the first scheduled Service.
- If confirmed inside the 72-hour window, the amount then due is ordinarily payable upon confirmation.
- A reservation payment may be required when a booking is confirmed.
- The amount of the reservation payment is not hardcoded by this Policy and must come from the applicable quote, invoice, booking confirmation, Pricing Policy, or approved Precise Petcare workflow.
- Any reservation payment applies toward the total booking balance.
- The ordinary remaining-balance deadline is 72 hours before the first Service unless another deadline is disclosed and agreed.
- A reservation payment is not automatically non-refundable.
- Cancellation treatment must defer to the Cancellation, Booking Change & Refund Policy.
- Payment deadlines and cancellation deadlines are separate concepts.
- The website must not imply that missing a payment deadline automatically eliminates a cancellation charge.
- A different booking-specific payment arrangement may be approved.

### Quotes and Booking Confirmation

- A website estimate is not a confirmed quote.
- A preliminary quote does not reserve calendar space.
- A quote does not guarantee availability.
- Unless otherwise stated, an unconfirmed preliminary quote expires after 30 days.
- Dates and times are reserved only after Cuddle Crew confirms the booking and applicable requirements due at confirmation are satisfied.
- The website must preserve a clear distinction among:
  - estimate;
  - quote;
  - booking request;
  - confirmed booking;
...
- Once confirmed, the agreed price for the confirmed Services and scope should be honored.
- General future rate increases do not retroactively change an existing confirmed booking.
- Client-requested scope changes may change the price.
- Payment timing or reservation-payment requirements do not themselves change the confirmed Service price.

### Access and Separate Trips

The website may explain the following where appropriate:

- Initial normal key exchange during the complimentary Meet & Greet: no separate fee.
- Normal approved lockbox, keypad, or smart-lock use: no separate access fee.
- Separate key/access trip:
  - Core or Standard: $15
  - Extended: $25
  - Far Extended: $35
- Client-caused access failure may leave the original reserved Service chargeable.
- A separate return trip may result in an additional applicable charge.
- No fee should be represented as applying merely to correct Cuddle Crew’s own access mistake.
- Discretionary waiver of a separate-trip fee does not change the standard policy.

### Direct Costs

- Routine overhead and included travel are built into ordinary pricing.
- Unusual Client-specific parking, tolls, approved replacement supplies, or similar direct costs may be passed through where authorized or reasonably necessary during an emergency.
- Do not add routine trivial backup-supply charges.

### Medication, Emergencies, and Extra Time

- Routine agreed oral or topical medication administration may be included where within scope and where it fits the booked Service.
- Do not automatically surcharge a Client merely because an emergency occurs.
- Substantial additional authorized Service time may be charged at the applicable Service rate.
- Advanced, high-risk, exact-time, unusually time-intensive, or complex medication/care requires individualized review rather than an arbitrary risk surcharge.

### Discounts and Courtesies

The website must not advertise or automatically calculate the following unless a future CURRENT / APPROVED source expressly creates them:
...
Individual courtesies may be provided but must not be converted into permanent public pricing rules.

Tips are optional and must not affect Service priority, quality, availability, or acceptance.

### Card Processing

Ordinary card-processing and payment-processing costs are included in pricing.

Do not add a routine credit-card convenience surcharge unless a future CURRENT / APPROVED pricing policy explicitly changes this rule.

### Past-Due Amounts

- Do not automatically calculate interest or punitive late fees unless a future approved policy creates them.
- Past-due balances may affect future booking confirmation.
- Required payment generally must be received before a new paid Service begins unless another arrangement is approved or animal-welfare circumstances require temporary action.
- Nonpayment does not automatically erase cancellation or payment obligations.

### Rate Changes

- Rates may change over time.
- Existing Clients should ordinarily receive approximately 30 days’ advance notice of normal rate increases.
- Do not promise lifetime grandfathered rates.
- Do not retroactively apply a new general rate to a previously confirmed booking merely because rates changed later.

### Custom Pricing and Personalized Review

The estimator must not force an automatic price where a booking materially differs from the standard Service structure.

Potential personalized-review situations may include:

- unusually large households;
- grouped-animal setups;
- unusual species;
- complex care routines;
- care that may exceed standard durations;
- Overnight Services outside the Standard travel area;
- unusual access requirements;
- or other nonstandard scope.

The public-facing result should ordinarily be:

**Personalized review required**

rather than exposing private internal acceptance thresholds or risk criteria.

A higher price must never be used to make an otherwise unsafe, unlawful, uninsurable, or out-of-scope Service appear acceptable.

### Refunds and Cancellations

- Refunds and cancellation charges must defer to the CURRENT / APPROVED Cancellation, Booking Change & Refund Policy.
- Do not duplicate separate cancellation logic that can drift out of sync.
- Where a refund is due, do not automatically replace it with a service credit unless the applicable policy or Client arrangement allows that treatment.

### Precise Petcare

- Precise Petcare quotes, invoices, confirmed bookings, and current approved records may establish booking-specific Services, prices, modifiers, reservation-payment requirements, and payment deadlines.
- Those records supplement this Policy.
- They do not silently override its legal terms.
- Website estimates must not override the final Precise Petcare quote, invoice, or confirmed booking.

### Conflict Handling

If existing website pricing, estimator logic, service descriptions, checkout behavior, payment messaging, travel calculations, or FAQs conflict with this Policy:

1. flag the conflict;
2. identify the affected component or content;
3. preserve the authoritative rule in this document;
4. correct the website only when instructed;
5. do not silently alter this document to match existing code.

## Codex Guardrails

- Do not infer missing pricing rules.
- Do not infer missing rates, fees, discounts, deadlines, deposits, reservation-payment percentages, travel classifications, or exceptions.
- Do not treat TODOs, old website values, previous code, examples, or superseded documents as current pricing authority.
- Treat the Authoritative Content section of this CURRENT / APPROVED document as the source of truth for the pricing and financial subjects it covers.
- Do not alter a rate or pricing rule merely to simplify implementation.
- Do not round or change approved prices without explicit instruction.
- Do not convert "may be subject to" into an automatic mandatory charge unless specifically directed by the authoritative rule.
- Do not automatically stack the $10 short-notice fee with the $20 same-day fee.
- Do not invent additional travel tiers.
- Do not classify service areas using live temporary traffic conditions when the authoritative rule uses ordinary/typical travel time.
- Do not expose the Contractor’s private service-area reference point publicly.
- Do not place a private routing origin or secret API credential in frontend code.
- Do not automatically price Overnight Services outside the Standard Zone using daytime travel surcharges.
- Do not infer a reservation-payment percentage.
- Do not assume a reservation payment is non-refundable.
- Do not confuse a reservation payment with a cancellation charge.
- Do not confuse a payment deadline with a cancellation deadline.
- Do not assume payment guarantees booking acceptance.
- Do not assume a preliminary quote reserves calendar space.
- Do not assume a website estimate constitutes a confirmed quote.
- Do not alter the price of an existing confirmed booking solely because generally published rates later changed.
- Do not automatically create discounts that are not expressly authorized.
- Do not convert a one-time courtesy or waived fee into a permanent pricing rule.
- Do not create a routine credit-card surcharge.
- Do not invent late fees or interest.
- Do not create an automatic "risk surcharge" for complex medication, behavior, emergencies, or unusual circumstances.
- Use personalized review where the standard pricing structure does not safely or reasonably fit.
- Do not expose private internal review thresholds merely to explain why personalized review is required.
- Do not make existing website code authoritative over this Policy.
- If another CURRENT / APPROVED reference materially conflicts with this Policy, flag the conflict for human review rather than silently reconciling it.
- If the user explicitly changes a pricing rule in a future task, identify this file as needing an authoritative update so implementation and documentation remain synchronized.
