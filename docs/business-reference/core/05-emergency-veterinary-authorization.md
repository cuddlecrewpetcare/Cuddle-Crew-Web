...
> Website use: Emergency-care workflow, veterinary escalation, emergency contacts, spending authorization concepts, transport limitations, and trust/safety messaging. Never expose client-specific emergency authorization information publicly.
