...
> Website use: Onboarding completion logic, required client/pet information, agreements, access testing, payment completion, travel-zone confirmation, and pre-service readiness.
