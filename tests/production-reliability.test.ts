...
test('FAQ cancellation summary preserves each approved booking category and policy boundary',()=>{
  ...
  for(const phrase of [
    ...
    'Holiday or designated peak-date daytime service, including 3–8 hour Continuous Care: at least seven days before the scheduled service receives a full refund or credit; less than seven days but at least 72 hours before the scheduled service may be charged 50%; less than 72 hours before the scheduled service may be charged 100%',
    'Holiday or designated peak-date Overnight and 24-Hour Continuous Care: at least 14 days before the first scheduled Overnight service receives a full refund or credit; less than 14 days but at least seven days before the first scheduled Overnight service may be charged 50%; less than seven days before the first scheduled Overnight service may be charged 100%',
